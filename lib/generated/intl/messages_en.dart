...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(maxCount) => "Only numbers between 1 and ${maxCount} are allowed.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "candyRechargeTitle": MessageLookupByLibrary.simpleMessage("Recharge Candy"),
    "cartCheckoutButton": MessageLookupByLibrary.simpleMessage("Checkout"),
    "cartEmptyText": MessageLookupByLibrary.simpleMessage("Your cart is empty."),
    ...
    "checkoutButtonHome": MessageLookupByLibrary.simpleMessage("Return to Home"),
    "checkoutSuccessDesc": MessageLookupByLibrary.simpleMessage(
      "Your Pokémon will be delivered soon.",
    ),
    "checkoutSuccessTitle": MessageLookupByLibrary.simpleMessage("Purchase Complete!"),
    ...
    "fieldRequiredError": MessageLookupByLibrary.simpleMessage("Please fill out all fields."),
    "goToShop": MessageLookupByLibrary.simpleMessage("Go buy Pokémon"),
    "goodsEmptyText": MessageLookupByLibrary.simpleMessage("No Pokémon available"),
    "goodsListTitle": MessageLookupByLibrary.simpleMessage("Pokémon List"),
    "goodsRegistration": MessageLookupByLibrary.simpleMessage("Do you want to register a Pokémon?"),
    "goodsSearchHint": MessageLookupByLibrary.simpleMessage("Search by Pokémon name."),
    "insufficientFunds": MessageLookupByLibrary.simpleMessage("Insufficient balance"),
    ...
    "itemListEmptyText": MessageLookupByLibrary.simpleMessage("No items available."),
    "itemMoreBrowse": MessageLookupByLibrary.simpleMessage("Browse more"),
    "itemNotFoundText": MessageLookupByLibrary.simpleMessage("Item does not exist."),
    "itemRemainingCountLabel": MessageLookupByLibrary.simpleMessage("Remaining quantity:"),
    ...
    "mainSubtitle": MessageLookupByLibrary.simpleMessage("Discover today\'s Pokémon!"),
    "mainTitle": MessageLookupByLibrary.simpleMessage("Rainbow City Pokémon Market"),
    "networkErrorText": MessageLookupByLibrary.simpleMessage("A network error occurred."),
    ...
    "pokemonDescriptionLabel": MessageLookupByLibrary.simpleMessage("Description"),
    ...
    "priceInputHint": MessageLookupByLibrary.simpleMessage("Enter numbers only."),
    "quantityInputError": m1,
    "quantityInputTitle": MessageLookupByLibrary.simpleMessage("Enter Quantity"),
    "rechargeAmount": MessageLookupByLibrary.simpleMessage("Select amount to recharge"),
    ...
    "rechargeSuccess": MessageLookupByLibrary.simpleMessage("Candy successfully recharged!"),
    "registerPokemonSubtitle": MessageLookupByLibrary.simpleMessage(
      "Enter the details of your Pokémon",
    ),
    "registerPokemonTitle": MessageLookupByLibrary.simpleMessage("Register Pokémon"),
    ...
    "unknownErrorText": MessageLookupByLibrary.simpleMessage("An unknown error occurred."),
